...
When workers start, they log discovered workflows and activities:
...
Workflows are automatically deduplicated when loaded from multiple packages. The system uses `dict.fromkeys()` to maintain order while removing duplicates.
